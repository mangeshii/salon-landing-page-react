                    ...
                    <div className="row  g-3 g-lg-4">
                        <div className="col-md-7 col-12">
                            <div className="p-3">
                                ...
                                <h5 className="sub-heading">Welcome bring the best service!</h5>
                                ...
                                <h6 className="detail-para">
                                    ...
                                    ornare.</h6><h6 className="detail-para">Duis scelerisque the nibhse drana
                                    moss pulvinar laie. Quality the biberon
                                    endum in finbus elit egethe solli citudin
                                    elit. Phasellus rutrum inle lacusut euismod.
                                    Vestibulum eleifend tortor eu misse endumin
                                    finbus elit eget the soli citudin elit.</h6> <h6 className="detail-para">
                                ...
                                <h4  className="ad">Betty White | Salon Owner</h4>
                            </div>
                        </div>
                        <div className="col-md-5 col-12">
                            <div className="p-3">fnwfe;lfewvwevvvvvvv</div>
                        </div>
                    </div>
                </div>
            </div>
